...
def print_episode_info(episode, n_episodes, episode_threshold=100):
    """_summary_

    Args:
        episode (int): _description_
        n_episodes (int): _description_
        episode_threshold (int, optional): _description_. Defaults to 100.
    """
...
def recorder(action, video_recorder=None, video_dir=None, recordings_dir_name=None, run=None, episode_base_name=None, env=None, i_episode=None):
    """_summary_

    Args:
        action (str): _description_
        video_recorder (_type_, optional): _description_. Defaults to None.
        video_dir (_type_, optional): _description_. Defaults to None.
        recordings_dir_name (str, optional): _description_. Defaults to None.
        run (int, optional): _description_. Defaults to None.
        episode_base_name (str, optional): _description_. Defaults to None.
        env (_type_, optional): _description_. Defaults to None.
        i_episode (int, optional): _description_. Defaults to None.
...
def print_results(runs_results, n_episodes=300, ylabel='return', xlabel='episode', title='title'):
    """_summary_

    Args:
        runs_results (_type_): _description_
        n_episodes (int, optional): _description_. Defaults to 300.
        ylabel (str, optional): _description_. Defaults to 'return'.
        xlabel (str, optional): _description_. Defaults to 'episode'.
...
def print_results_several(runs_results_list, n_episodes=300, ylabel='return', xlabel='episode', title='title'):
    """Prints episode results over multiple (2) batches of runs.

    Args:
        runs_results_list (_type_): _description_
        n_episodes (int, optional): _description_. Defaults to 300.
        ylabel (str, optional): _description_. Defaults to 'return'.
        xlabel (str, optional): _description_. Defaults to 'episode'.
        title (str, optional): _description_. Defaults to 'title'.
...
def print_batch(batch_runs, ylabel, xlabel, title, legends):
    """Prints the results of hyperparameter tuning across different hyperparameters.

    Args:
        batch_runs (_type_): _description_
